...
class Styler:
    ...
    def become_stylish(self):
        ...
        self.style.map('C.Vertical.TScrollbar',
        ...
        self.style.map(         'TEntry',
            ...
            foreground          = [ ('disabled',Cfff),('!focus',WINDOW_COLOR), ('focus',"#ffefd8")    ],
            background          = [ ('disabled',C333),('focus',C444), ('!focus',C222)    ],
            bordercolor         = [ ('disabled',C444),('focus',C444), ('!focus',WINDOW_COLOR)    ],
            insertcolor         = [ ('focus',Cfff),('!focus',Cff1c)    ],
            fieldbackground     = [ ('disabled',C333),('focus',C222),('!focus',"#aaaaaa")    ],
            selectbackground    = [ ('disabled','#007f5b'), ('!disabled','#007f5b') ],
        );
        self.style.map(         'C.TLabel',

            foreground          = [ ('disabled',Cfff), ('!disabled',"#ffefd8")    ],
            background          = [ ('disabled',C333),('!disabled',WINDOW_COLOR)  ],
            bordercolor         = [ ('disabled',C444),('focus',C444), ('!focus',WINDOW_COLOR)    ],
        );
