...
class CEntry(ttk.Entry): # https://stackoverflow.com/a/75367456
    ...
    def set_bindings(self):
        ...
        self.bind   ("<Control-a>",             self._select_all)
        self.bind   ("<Control-Button>",        self._emit_zoom)
        self.bind   ("<Alt-Button>",            self._emit_scroll)
    ...
    def _emit_zoom(self,e):
        if e.num == 4 or e.num == 6:
            self.event_generate('<<ZoomIn>>')
        elif e.num == 5 or e.num == 7:
            self.event_generate('<<ZoomOut>>')
    ...
    def clearMenu(self):
        ...
        if self.cleared_menu == False:
            self.context_menu.delete(0,"end")
            self.cleared_menu = True
